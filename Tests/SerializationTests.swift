...
class SerializationTests: XCTestCase {
	func testZulu() {
		...
		XCTAssertEqual(parse("1999-05-19T23:55:21.123"), components(year: 1999, month: 5, day: 19, hour: 23, minute: 55, second: 21, millisecond: 123))
	}
	...
	func testReadingUTC() {
		...
		XCTAssertEqual(parse("1971-02-03T04:05:06.78Z"), components(year: 1971, month: 2, day: 3, hour: 4, minute: 5, second: 6, millisecond: 78, timeZoneOffset: 0))
		XCTAssertEqual(parse("1971-02-03T04:05:06.7Z"), components(year: 1971, month: 2, day: 3, hour: 4, minute: 5, second: 6, millisecond: 7, timeZoneOffset: 0))
		...
		XCTAssertEqual(parse("3001-01-01T08:00:00.000Z"), components(year: 3001, month: 1, day: 1, hour: 8, minute: 0, second: 0, millisecond: 00, timeZoneOffset: 0))
	...
	func testReadingTimeZones() {
		...
		XCTAssertEqual(parse("1971-02-03T09:16:06.78+0511"), components(year: 1971, month: 2, day: 3, hour: 9, minute: 16, second: 6, millisecond: 78, timeZoneOffset: 18660))
		XCTAssertEqual(parse("1971-02-03T09:16:06.7+0511"), components(year: 1971, month: 2, day: 3, hour: 9, minute: 16, second: 6, millisecond: 7, timeZoneOffset: 18660))
