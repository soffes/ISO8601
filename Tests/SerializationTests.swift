...
class SerializationTests: XCTestCase {
	...
	func testReadingUTC() {
		...
		XCTAssertEqual(parse("1970-01-01T00:00:00.000Z"), components(year: 1970, month: 1, day: 1, hour: 0, minute: 0, second: 0, millisecond: 0, timeZoneOffset: 0))
		...
		XCTAssertEqual(parse("3001-01-01T08:00:00.000Z"), components(year: 3001, month: 1, day: 1, hour: 8, minute: 0, second: 0, millisecond: 0, timeZoneOffset: 0))
		...
		XCTAssertEqual(parse("2013-02-20T18:29:11.1000Z"), components(year: 2013, month: 2, day: 20, hour: 18, minute: 29, second: 11, millisecond: 100, timeZoneOffset: 0))
		XCTAssertEqual(parse("2013-02-20T18:29:11.100000Z"), components(year: 2013, month: 2, day: 20, hour: 18, minute: 29, second: 11, millisecond: 100, timeZoneOffset: 0))
		XCTAssertEqual(parse("2013-02-20T18:29:11.000123Z"), components(year: 2013, month: 2, day: 20, hour: 18, minute: 29, second: 11, microsecond: 123, timeZoneOffset: 0))
		XCTAssertEqual(parse("2013-02-20T18:29:11.001234Z"), components(year: 2013, month: 2, day: 20, hour: 18, minute: 29, second: 11, microsecond: 1234, timeZoneOffset: 0))
		XCTAssertEqual(parse("2013-02-20T18:29:11.012345Z"), components(year: 2013, month: 2, day: 20, hour: 18, minute: 29, second: 11, microsecond: 12345, timeZoneOffset: 0))
		XCTAssertEqual(parse("2013-02-20T18:29:11.123456Z"), components(year: 2013, month: 2, day: 20, hour: 18, minute: 29, second: 11, microsecond: 123456, timeZoneOffset: 0))
	}
	...
	func testReadingTimeZones() {
		...
		XCTAssertEqual(parse("1969-12-31T16:00:00.000-0800"), components(year: 1969, month: 12, day: 31, hour: 16, minute: 0, second: 0, millisecond: 0, timeZoneOffset: -28800))
	...
	func testLeapYear() {
		XCTAssertEqual(parse("1972-02-29T00:00:00.000Z"), components(year: 1972, month: 2, day: 29, hour: 0, minute: 0, second: 0, millisecond: 0, timeZoneOffset: 0))
		XCTAssertEqual(parse("1976-02-29T00:00:00.000Z"), components(year: 1976, month: 2, day: 29, hour: 0, minute: 0, second: 0, millisecond: 0, timeZoneOffset: 0))
		XCTAssertEqual(parse("1980-02-29T00:00:00.000Z"), components(year: 1980, month: 2, day: 29, hour: 0, minute: 0, second: 0, millisecond: 0, timeZoneOffset: 0))
		XCTAssertEqual(parse("1984-02-29T00:00:00.000Z"), components(year: 1984, month: 2, day: 29, hour: 0, minute: 0, second: 0, millisecond: 0, timeZoneOffset: 0))
		XCTAssertEqual(parse("1988-02-29T00:00:00.000Z"), components(year: 1988, month: 2, day: 29, hour: 0, minute: 0, second: 0, millisecond: 0, timeZoneOffset: 0))
		XCTAssertEqual(parse("1992-02-29T00:00:00.000Z"), components(year: 1992, month: 2, day: 29, hour: 0, minute: 0, second: 0, millisecond: 0, timeZoneOffset: 0))
		XCTAssertEqual(parse("1996-02-29T00:00:00.000Z"), components(year: 1996, month: 2, day: 29, hour: 0, minute: 0, second: 0, millisecond: 0, timeZoneOffset: 0))
		XCTAssertEqual(parse("2000-02-29T00:00:00.000Z"), components(year: 2000, month: 2, day: 29, hour: 0, minute: 0, second: 0, millisecond: 0, timeZoneOffset: 0))
		XCTAssertEqual(parse("2004-02-29T00:00:00.000Z"), components(year: 2004, month: 2, day: 29, hour: 0, minute: 0, second: 0, millisecond: 0, timeZoneOffset: 0))
		XCTAssertEqual(parse("2008-02-29T00:00:00.000Z"), components(year: 2008, month: 2, day: 29, hour: 0, minute: 0, second: 0, millisecond: 0, timeZoneOffset: 0))
		XCTAssertEqual(parse("2012-02-29T00:00:00.000Z"), components(year: 2012, month: 2, day: 29, hour: 0, minute: 0, second: 0, millisecond: 0, timeZoneOffset: 0))
		XCTAssertEqual(parse("2016-02-29T00:00:00.000Z"), components(year: 2016, month: 2, day: 29, hour: 0, minute: 0, second: 0, millisecond: 0, timeZoneOffset: 0))
	}
	...
	func testReadingExtensively() {
		...
		XCTAssertEqual(parse("2014-03-18T20:00:00.000-07:00"), components(year: 2014, month: 3, day: 18, hour: 20, minute: 0, second: 0, millisecond: 0, timeZoneOffset: -7 * 60 * 60))
	...
	func testPartials() {
		...
		XCTAssertEqual(parse("2015-03-13T10:42:10.💩"), components(year: 2015, month: 3, day: 13, hour: 10, minute: 42, second: 10))
		XCTAssertEqual(parse("2015-03-13T10:42:10.100"), components(year: 2015, month: 3, day: 13, hour: 10, minute: 42, second: 10, millisecond: 100))
		XCTAssertEqual(parse("2015-03-13T10:42:10+💩"), components(year: 2015, month: 3, day: 13, hour: 10, minute: 42, second: 10))
	}
