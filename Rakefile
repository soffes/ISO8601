...
task :test do
  ...
  sh 'xcodebuild test -project ISO8601.xcodeproj -scheme ISO8601 -destination \'platform=iOS Simulator,name=iPhone 4s,OS=latest\' | bundle exec xcpretty --color; exit ${PIPESTATUS[0]}'
end
